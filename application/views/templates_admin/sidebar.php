      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="<?= base_url('admin/dashboard'); ?>">APP MONITORING MOBIL</a>
          </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a class="nav-link" href="<?= base_url('admin/data_customer'); ?>"><i class="fas fa-users"></i> <span>Data Karyawan</span></a></li>
