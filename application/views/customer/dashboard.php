...
<div class="main-banner header-text">
  <div class="container-fluid">
    <div class="owl-banner owl-carousel">
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/Gambar-3.jpeg" alt="">
      ...
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/Gambar-1.jpeg" alt="">
        <div class="item-content">
          <div class="main-content">
            <div class="meta-category">
              <span>
      ...
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/Gambar-4.jpeg" alt="">
        <div class="item-content">
          <div class="main-content">
            <div class="meta-category">
              <span>
      ...
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/Gambar-5.jpeg" alt="">
        <div class="item-content">
          <div class="main-content">
            <div class="meta-category">
              <span>
      ...
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/Gambar-6.jpeg" alt="">
        <div class="item-content">
          <div class="main-content">
            <div class="meta-category">
              <span>
      ...
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/Gambar-7.jpeg" alt="">
        <div class="item-content">
          <div class="main-content">
            <div class="meta-category">
              <span>
    ...
    <div class="all-blog-posts">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6">
          <div class="blog-post">
            <div class="blog-thumb">
              <img src="<?= base_url('assets/assets_shop') ?>/images/blog-1.jpeg" alt="">
            </div>
            <div class="down-content">
        ...
        <div class="col-md-4 col-sm-6">
          <div class="blog-post">
            <div class="blog-thumb">
              <img src="<?= base_url('assets/assets_shop') ?>/images/blog-2.jpeg" alt="">
            </div>
            <div class="down-content">
              <a href="blog-details.html"><h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit</h4></a>
        ...
        <div class="col-md-4 col-sm-6">
          <div class="blog-post">
            <div class="blog-thumb">
              <img src="<?= base_url('assets/assets_shop') ?>/images/blog-3.jpeg" alt="">
            </div>
            <div class="down-content">
              <a href="blog-details.html"><h4>Lorem ipsum dolor sit amet, consectetur adipisicing elit</h4></a>
